...
class AExcelWeeklyTrainingScheduleComponent extends Component
{
    ...
    public function export($selected_batch)
    {
        ...
        try {
            return Excel::download(new WeeklyTrainingScheduleExport([$training_schedules_type, $special_schedules,$course_type,$week, 
            $date_array, $previousSundayFormatted, $online_schedule, $show_sched, $s_show_sched, $count]), $filenameExport);
        } catch (Exception $e) {
            dd($e);
        }
    }
