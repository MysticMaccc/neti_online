...
$changepasspin = (empty($_POST["otp"])) ?"":$_POST["otp"];

ob_start();
$html = include 'changePWEmailFormat.php';
$content = ob_get_clean();

//echo $content;

//send email
sendmail($content,$email,"Change Password Pin");
...
// ----------------------------------------SMS-----------------------------------------
              ...
              $tar_msg = " Welcome to NETI Enrollment System. Your Change Password verification code is: ".$changepasspin.". Please enter this code on the verification page to complete the login process. Do not share this OTP with anyone.";
              $tar_mode = "text";
              $label = "";
              $priority = "1";
              $clientid = "";
