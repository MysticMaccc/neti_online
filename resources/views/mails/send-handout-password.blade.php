...
<style>
		* {
        ...
        /* CSS for table cells (optional) */
        .handoutTD {
        border: 1px solid blue; /* Blue border for table cells */
        padding: 8px; /* Optional padding for content within cells */
        }
...
<h1 style="margin: 0; color: #4f5aba; direction: ltr; font-family: 'Noto Serif', Georgia, serif; font-size: 34px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Handout Password</span></h1>
</td>
</tr>
</table>
...
<p style="margin: 0; margin-bottom: 0px;"> </p>
<p style="margin: 0; margin-bottom: 0px;">Kindly see passwords for this week's handouts.</p> 
<p style="margin: 0; margin-bottom: 0px;"> </p>
<table class="handoutTable">
        <thead>
                <tr>
                        <th class="handoutTH">Course</th>
                        <th class="handoutTH" >Password</th>
                </tr>
        </thead>
        <tbody>
                @foreach($courses as $course)
                    <tr>
                            <td class="handoutTD">{{$course->coursecode}}</td>
                            <td class="handoutTD">{{$course->handout_password}}</td>
                    </tr>
                @endforeach
        </tbody>
</table>
