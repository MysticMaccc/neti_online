                                  ...
                                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                      <td valign="top" class="textContent">
                                        ...
                                        <div
                                          ...
                                          Welcome to NETI Online Enrollment System. Your One Time Password is:</div>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td align="center" valign="top" width="500" class="flexibleContainerCell">
                                          ...
                                          <tr>
                                            <td align="center" valign="top">
                                              <table border="0" cellpadding="0" cellspacing="0" width="50%"
                                                class="emailButton" style="background-color: #05093D;">
                                                <tr>
                                    ...
                                    <tr>
                                      <td valign="top" class="textContent">
                                        <div
                                          style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">
                                          Please enter the code above on the verification page to complete the login
                                          process, and do not share this OTP with anyone.</div>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
