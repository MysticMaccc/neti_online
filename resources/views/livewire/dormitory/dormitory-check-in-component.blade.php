                ...
                <div class="card-header col-lg-12">
                    ...
                    <div class="row">
                        ...
                        @if ($datefrom)
                            <div class="col-lg-2">
                                <div class="form-check">
                                    |<input class="form-check-input" wire:model="showreserved" type="checkbox" value="" id="showreserved">
