<section class="container-fluid p-4">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item" data-bs-toggle="modal"
                                                            ...
                                                            wire:click="statusedit({{ $email_inquiries->emailinquiryid }})">
    ...
    <!-- UPDATE STATUS -->
    <div wire:ignore.self class="modal fade" id="updatestatus" tabindex="-1" role="dialog"
                    ...
                    <form id="updatestatusForm" wire:submit.prevent="updatestatus">
                        <div class="row">
                            <div class="mb-3 col-12">
                                ...
                                <select class="form-select text-black" data-width="100%" wire:model.defer="selectstatus"
                                    required>
